		          ...
		          <div class="col-md-12 d-flex align-items-center">
		            ...
		            <div class="tab-content ftco-animate" id="v-pills-tabContent">
		              ...
		              <div class="tab-pane fade show active" id="v-pills-2" role="tabpanel" aria-labelledby="v-pills-2-tab">
						...
						$Strt_page = ($get_pg - 1) * $limit;
						
						$productsfetch = "SELECT * from products order by id desc limit {$Strt_page}, {$limit}";
						...
						$runpagination = mysqli_query($connection, $pagination);
							...
							$total_records = mysqli_num_rows($runpagination);
							
							$total_pages = ceil($total_records / $limit);
							echo '<ul class="pagination">';
							if($get_pg > 1){
								echo '<li class="page-item"><a class="page-link btn btn-primary" href="menu.php?pg='.($get_pg - 1).'">Previous</a></li>'; 

							}
							for($i = 1; $i <= $total_pages; $i++){
								$active = $i == $get_pg? "active" : "";
								echo '<li class="page-item"><a class="'.$active.'page-link btn btn-primary" href="menu.php?pg='.$i.'">'.$i.'</a></li>';
							}
							if($get_pg < $total_pages){
								echo '<li class="page-item"><a class="page-link btn btn-primary" href="menu.php?pg='.($get_pg + 1).'">Next</a></li>'; 
